...
${OBJECTDIR}/CArea.o: CArea.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CArea.o CArea.cpp

${OBJECTDIR}/CImage.o: CImage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CImage.o CImage.cpp

${OBJECTDIR}/CInterferogram.o: CInterferogram.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CInterferogram.o CInterferogram.cpp

${OBJECTDIR}/CParam.o: CParam.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CParam.o CParam.cpp

${OBJECTDIR}/CSet.o: CSet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gdal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSet.o CSet.cpp
