...
COHERENCETHRESHOLD = Component.Parameter(
    'CoherenceThreshold',
    public_name='COHERENCETHRESHOLD',
    default=None,
    type=float,
    mandatory=True,
    intent='input',
    doc='Coherence threshold for mask'
)

INTENSITYTHRESHOLD = Component.Parameter(
    'IntensityThreshold',
    public_name='INTENSITYTHRESHOLD',
    default=None,
    type=float,
    mandatory=True,
    intent='input',
    doc='Relative intensity threshold for mask'
)

AVE_COR = Component.Parameter(
    'AverageCoherence',
    public_name='AVE_COR',
    default=None,
    type=str,
    mandatory=True,
    intent='input',
    doc='Average correlation file name'
)

AVE_MLI = Component.Parameter(
    'AverageIntensity',
    public_name='AVE_MLI',
    default=None,
    type=str,
    mandatory=True,
    intent='input',
    doc='Average intensity file name'
)
...
class Snaphu(Component):
    ...
    def setCoherenceThreshold(self, ccthres):
        self.CoherenceThreshold = ccthres

    def setIntensityThreshold(self, pwrthres):
        self.IntensityThreshold = pwrthres
        
    def setAverageCoherence(self, avecor):
    	self.AverageCoherence = avecor

    def setAverageIntensity(self, avemli):
    	self.AverageIntensity = avemli
    ...
    def prepare(self):
        ...
        snaphu.setCoherenceThreshold_Py(float(self.CoherenceThreshold))
        snaphu.setIntensityThreshold_Py(float(self.IntensityThreshold))
        if self.AverageCoherence is not None:
            snaphu.setAverageCoherence_Py(self.AverageCoherence)
        if self.AverageIntensity is not None:
            snaphu.setAverageIntensity_Py(self.AverageIntensity)
