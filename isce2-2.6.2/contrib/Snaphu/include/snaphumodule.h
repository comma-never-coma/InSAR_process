...
static PyMethodDef snaphu_methods[] =
{
    ...
    {"setCoherenceThreshold_Py", setCoherenceThreshold_C, METH_VARARGS, " "},
    {"setIntensityThreshold_Py", setIntensityThreshold_C, METH_VARARGS, " "},
    {"setAverageCoherence_Py", setAverageCoherence_C, METH_VARARGS, " "},
    {"setAverageIntensity_Py", setAverageIntensity_C, METH_VARARGS, " "},
    {NULL,NULL,0,NULL}
};
