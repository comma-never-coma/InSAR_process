...
def createParser():
    ...
    parser.add_argument('--nfft', dest='FFTwindow', type=str, default='32',
                        help='filtering FFT window size (default: %(default)s, 16 --> 128)')
    ...
    parser.add_argument('-ccThres', '--cc_thres', dest='coherenceThreshold', type=str, default='0.4',
                        help='coherence threshold for masking, magnitude values of pixels with cc < ccThres are set to 0')

    parser.add_argument('-pwrThres', '--pwr_thres', dest='intensityThreshold', type=str, default='0.1',
                        help='relative intensity threshold for masking, magnitude values of pixels with intensit < pwrThres * average intensity are set to 0')
