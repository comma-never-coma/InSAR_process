...
class config(object):
    ...
    def FilterAndCoherence(self, function):
        ...
        self.f.write('nfft : ' + self.FFTwindow + '\n')
    ...
    def unwrap(self, function):
        ...
        self.f.write('cc_thres : ' + self.coherenceThreshold + '\n')
        self.f.write('pwr_thres : ' + self.intensityThreshold + '\n')
        if self.rmFilter:
...
class run(object):
    ...
    def unpackSecondarysSLC(self,  stackReferenceDate, secondaryList, safe_dict):
        ...
        for i,secondary in enumerate(secondaryList):
            ...
            if i!=len(secondaryList)-1:
                line_cnt += 1
                line_cnt = configObj.write_wrapper_config2run_file(configName, line_cnt, 1)
            else:
                line_cnt = None
                line_cnt = configObj.write_wrapper_config2run_file(configName, line_cnt, 1)
            del configObj
